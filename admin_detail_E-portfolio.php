...
<body>
    ...
    <div class="main-content">
                ...
                <div
                    ...
                    <div class="profile-info">
                        ...
                        <div class="d-flex gap-2 mb-2 badge-container">
                            <span class="badge bg-light text-primary border p-2"><i class="fas fa-flask"></i>
                                คณะวิทยาศาสตร์และเทคโนโลยี</span>
                            <span class="badge bg-light text-primary border p-2">
                                <i class="fas fa-book"></i>
                                <?php echo htmlspecialchars($user_profile['department'] ?? 'ไม่ระบุสาขาวิชา'); ?>
                                <?php echo !empty($user_profile['year_level']) ? '('.htmlspecialchars($user_profile['year_level']).')' : ''; ?>
                            </span>
                        </div>
                    </div>
                    <div class="export-btn-container mb-2">
                        <button class="btn btn-primary px-4 py-2 rounded-pill shadow-sm fw-bold d-print-none"
        ...
        <div class="row g-4 mt-2">
            <div class="col-12">
                <h4 class="fw-bold mb-4 border-bottom pb-3 text-dark"><i class="far fa-images me-2 text-primary"></i>
                    แกลเลอรี่กิจกรรมและผลงาน</h4>
                        ...
                        <div class="col-md-8">
                            <div class="card-body d-flex flex-column h-100 p-4">
                                <div class="d-flex justify-content-between align-items-start mb-2">
                                    <small class="text-primary fw-bold bg-light px-2 py-1 rounded border"><i
                                            class="fa-regular fa-calendar-days me-1"></i>
                                        <?php echo $date_display; ?></small>
                                    <span class="status-pass shadow-sm"><i class="fa-solid fa-check-circle me-1"></i>
                                        ผ่าน</span>
                                </div>
                                <h5 class="card-title fw-bold text-dark mt-2 mb-2">
                                    <?php echo htmlspecialchars($act['title']); ?></h5>
                                <p class="card-text text-muted mb-3"
                                    style="display: -webkit-box; -webkit-line-clamp: 3; -webkit-box-orient: vertical; overflow: hidden; font-size: 0.95rem;">
                                    <?php echo htmlspecialchars($act['description']); ?>
                                </p>
                                <div
                                    class="mt-auto d-flex flex-wrap justify-content-between align-items-center text-dark small bg-light p-3 rounded-3 border">
                                    <span class="mb-2 mb-md-0"><i class="fa-solid fa-user-tag me-1 text-primary"></i>
                                        หน้าที่รับผิดชอบ:
                                        <strong><?php echo htmlspecialchars($act['task_name'] ?? 'ผู้เข้าร่วมทั่วไป'); ?></strong></span>
                                    <span class="badge bg-warning text-dark px-3 py-2 rounded-pill fs-6"><i
                                            class="fa-regular fa-clock me-1"></i>
                                        <strong><?php echo intval($act['hours_count']); ?></strong> ชั่วโมง</span>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="text-center py-5 bg-white rounded-4 shadow-sm border-0 empty-portfolio">
                    <div class="mb-3">
                        <div
                            style="width: 80px; height: 80px; background-color: #f8f9fc; border-radius: 50%; display: inline-flex; align-items: center; justify-content: center; margin: 0 auto;">
        ...
        <div class="position-fixed bottom-0 end-0 p-4 d-print-none" style="z-index: 1000;">
            <button class="btn btn-dark rounded-circle p-3 shadow-lg border-2 border-white" onclick="window.print()"
