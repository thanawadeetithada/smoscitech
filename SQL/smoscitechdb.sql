...
--
-- Host: 127.0.0.1
-- Generation Time: May 18, 2026 at 06:02 AM
...
CREATE TABLE `users` (
  ...
  `membership_status` enum('pending','member','no_member') NOT NULL DEFAULT 'pending',
  `created_at` timestamp NOT NULL DEFAULT current_timestamp(),
...
--
ALTER TABLE `activity_evidences`
  MODIFY `evidence_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=25;
...
--
ALTER TABLE `user_skills`
  MODIFY `skill_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=195;
