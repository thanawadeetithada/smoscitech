    ...
    <div class="wrapper">
        ...
        <div class="main-wrapper">
            <aside class="sidebar">
                ...
                <a href="main_e-portfolio.php" class="sidebar-item mb-3" style="background: #FDFDFD;">
            ...
            <main class="content-area">
                <div class="search-wrap w-100">
                    <div class="search-input-group">
                        ...
                        <input type="text" class="search-name" placeholder="ค้นหาชื่อ...">
                    </div>
                </div>
                            ...
                            <?php if ($result->num_rows > 0): ?>
                                <?php while ($row = $result->fetch_assoc()): ?>
                                    <tr class="member-row" 
                                        ...
                                        <td>
                                            <a href="main_detail_E-portfolio.php?user_id=<?= $row['user_id'] ?>&action=portfolio" title="ดูแฟ้มสะสมผลงาน">
