...
<head>
    ...
    <title><?php echo $can_edit ? 'แก้ไขกิจกรรม' : 'รายละเอียดกิจกรรม'; ?> - SMO SCITECH</title>
...
<body>
            ...
            <main class="content-area">
                <div class="container-fluid mx-auto" style="max-width: 1000px;">
                    <div class="d-flex align-items-center mb-4">
                        ...
                        <div>
                            <h4 class="fw-bold mb-0 text-dark"><?php echo $can_edit ? 'แก้ไขข้อมูลกิจกรรม' : 'รายละเอียดกิจกรรม'; ?></h4>
                        </div>
                    </div>
                    ...
                    <form action="process_edit_activity.php" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="row g-4">
                                    <div class="col-md-12">
                                        ...
                                        <?php if($activity['cover_image']): ?>
                                            <img src="uploads/covers/<?php echo htmlspecialchars($activity['cover_image']); ?>" class="current-cover">
                                        <?php else: ?>
                                            <div class="p-3 bg-light text-muted border rounded mb-2 text-center">ยังไม่มีรูปหน้าปก</div>
                                        <?php endif; ?>

                                        <?php if($can_edit): ?>
                                        <input type="file" name="cover_image" class="form-control" accept="image/*">
                                        <small class="text-muted">* อัปโหลดใหม่เพื่อเปลี่ยนรูปเดิม</small>
                                        <?php endif; ?>
                                    </div>
                                    <div class="col-md-12">
                                        <label class="form-label">ชื่อกิจกรรม <span class="text-danger">*</span></label>
                                        <input type="text" name="title" class="form-control" value="<?php echo htmlspecialchars($activity['title']); ?>" required <?php echo $disabled; ?>>
                                    </div>
                                    <div class="col-md-12">
                                        <label class="form-label">รายละเอียดกิจกรรม</label>
                                        <textarea name="description" class="form-control" rows="4" <?php echo $disabled; ?>><?php echo htmlspecialchars($activity['description']); ?></textarea>
                                    </div>
                                    <div class="col-md-5">
                                        <label class="form-label">สถานที่จัดกิจกรรม</label>
                                        <input type="text" name="location" class="form-control" value="<?php echo htmlspecialchars($activity['location']); ?>" <?php echo $disabled; ?>>
                                    </div>
                                    <div class="col-md-3">
                                        <label class="form-label">จำนวนชั่วโมงกิจกรรม (กยศ.)</label>
                                        <input type="number" name="hours_count" class="form-control" value="<?php echo $activity['hours_count']; ?>" min="0" <?php echo $disabled; ?>>
                                    </div>
                                    <div class="col-md-4">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="datetime-local" name="start_date" class="form-control" value="<?php echo date('Y-m-d\TH:i', strtotime($activity['start_date'])); ?>" required <?php echo $disabled; ?>>
                                    </div>
                                    <div class="col-md-6">
                                        <label class="form-label">วัน/เวลาที่สิ้นสุดลงทะเบียน <span class="text-danger">*</span></label>
                                        <input type="datetime-local" name="end_date" class="form-control" value="<?php echo date('Y-m-d\TH:i', strtotime($activity['end_date'])); ?>" required <?php echo $disabled; ?>>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card-body p-4">
                                <div class="row g-4">
                                    <div class="col-md-4">
                                        ...
                                        <select name="target_year_level[]" class="form-select select2-multiple" multiple="multiple" data-placeholder="เลือกชั้นปี..." <?php echo $disabled; ?>>
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <select name="target_academic_year[]" class="form-select select2-multiple" multiple="multiple" data-placeholder="เลือกปีการศึกษา..." <?php echo $disabled; ?>>
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <select name="target_department[]" class="form-select select2-multiple" multiple="multiple" data-placeholder="เลือกสาขาวิชา..." <?php echo $disabled; ?>>
                                    ...
                                    <div class="task-row">
                                        ...
                                        <div class="row g-3">
                                            <div class="col-md-5">
                                                ...
                                                <input type="text" name="task_name[]" class="form-control" value="<?php echo htmlspecialchars($task['task_name']); ?>" required <?php echo $disabled; ?>>
                                            </div>
                                            <div class="col-md-3">
                                                <label class="form-label small">จำนวนที่รับ (คน)</label>
                                                <input type="number" name="task_capacity[]" class="form-control" value="<?php echo $task['capacity']; ?>" min="1" <?php echo $disabled; ?>>
                                            </div>
                                            <div class="col-md-4">
                                                <label class="form-label small">รายละเอียด</label>
                                                <input type="text" name="task_detail[]" class="form-control" value="<?php echo htmlspecialchars($task['task_detail']); ?>" <?php echo $disabled; ?>>
                                            </div>
                                        </div>
                                    </div>
                                    <?php endwhile; ?>
                        ...
                        <div class="d-flex justify-content-center gap-3 mt-4 mb-5">
                            <?php if($can_edit): ?>
                            <a href="admin_activity.php" class="btn btn-outline-custom px-4">ยกเลิก</a>
                            <button type="submit" class="btn btn-purple-custom px-5"><i class="fas fa-save me-2"></i>บันทึกการเปลี่ยนแปลง</button>
                            <?php else: ?>
                            <a href="admin_activity.php" class="btn btn-purple-custom px-5">กลับหน้าหลัก</a>
                            <?php endif; ?>
                        </div>
                    </form>
                </div>
    ...
    function addTask() {
        ...
        <div class="row g-3">
            <div class="col-md-5">
                <label class="form-label small">ชื่อฝ่าย/หน้าที่ <span class="text-danger">*</span></label>
                <input type="text" name="task_name[]" class="form-control" placeholder="เช่น ฝ่ายสถานที่" required>
            </div>
            <div class="col-md-3">
                <label class="form-label small">จำนวนที่รับ (คน)</label>
