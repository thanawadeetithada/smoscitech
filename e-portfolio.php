...
<head>
    ...
    <title>E-Portfolio - SMO SCITECH</title>
    ...
    <div class="main-wrapper">
        <aside class="sidebar d-print-none">
            <a href="report_activity.php" class="sidebar-item mt-3 mb-3">
                <i class="fa-solid fa-chart-line"></i><span>สถิติการเข้าร่วมกิจกรรม</span>
            </a>
            <a href="e-portfolio.php" class="sidebar-item mb-3" style="background: #FDFDFD;">
                <i class="fa-solid fa-book-open"></i><span>E -portfolio</span>
            </a>
            <a href="user_management.php" class="sidebar-item mb-3">
                <i class="fa-solid fa-users"></i><span>ข้อมูลสมาชิก</span>
            </a>
            <a href="activity.php" class="sidebar-item mb-3">
                <i class="fa-solid fa-calendar-days"></i><span>ข้อมูลกิจกรรม</span>
            </a>
        </aside>
                    ...
                    <div class="about-text">
                        <?php 
                            if(!empty($user_profile['about_me'])) {
                                ...
                                echo "“ความสำเร็จไม่ได้ขึ้นอยู่กับโชคชะตา แต่อยู่ที่ความพยายาม” (กรุณากดปุ่มแก้ไขข้อมูลเพื่อเพิ่มประวัติส่วนตัวของคุณเอง เพื่อนำเสนอตัวตนของคุณให้โดดเด่นมากยิ่งขึ้น)";
                            }
                        ?>
                    </div>
