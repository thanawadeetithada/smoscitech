                ...
                <div class="card-body p-4 p-md-5">
                    ...
                    <div class="row g-4 mb-4">
                        ...
                        <div class="col-md-6 d-flex align-items-center">
                            ...
                            <div>
                                ...
                                <strong
                                    class="text-dark"><?php echo htmlspecialchars($activity['location'] ?? 'ไม่ระบุ'); ?></strong>
                            </div>
                        </div>
                        <div class="col-md-6 d-flex align-items-center">
                            ...
                            <div>
                                ...
                                <strong class="text-dark"><?php echo intval($activity['hours_count']); ?> ชั่วโมง
                                    (กยศ.)</strong>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="mt-5 bg-light p-4 rounded-4 border">
                        <h5 class="fw-bold mb-4 text-primary"><i
                                class="fa-solid fa-clipboard-user me-2"></i>ลงทะเบียนเข้าร่วมกิจกรรม</h5>
                        ...
                        <div class="alert <?php echo $reg_alert; ?> text-center mb-0">
                            <i class="fa-solid fa-info-circle me-2"></i> คุณได้ลงทะเบียนกิจกรรมนี้ไปแล้ว (สถานะ:
                            <strong><?php echo $reg_msg; ?></strong>)
                        </div>
                        ...
                        <div class="alert alert-danger text-center mb-0">
                            ...
                            <strong>สิ้นสุดลงแล้ว</strong> ไม่สามารถลงทะเบียนได้
                        </div>
                        ...
                        <form action="" method="POST" id="joinForm">
                                        ...
                                        <div class="task-card p-3">
                                            <div class="d-flex justify-content-between align-items-center mb-1">
                                                <h6 class="fw-bold mb-0 text-dark">
                                                    <?php echo htmlspecialchars($task['task_name']); ?></h6>

                                                <span
                                                    class="badge <?php echo $is_exceeded ? 'bg-danger' : 'bg-primary'; ?> rounded-pill">
                                                    <?php echo $task['current_reg']; ?> /
                                                    <?php echo $task['capacity']; ?> คน
                                                </span>
                                            </div>
                                            <small
                                                class="text-muted"><?php echo htmlspecialchars($task['task_detail'] ?? 'ไม่มีรายละเอียดเพิ่มเติม'); ?></small>
                                        </div>
                                    </label>
                                </div>
                                <?php endforeach; ?>
                            ...
                            <div class="text-center mt-4 pt-3 border-top">
                                <button type="submit" name="join_activity"
                                    class="btn btn-purple btn-lg px-5 rounded-pill shadow-sm fw-bold">
