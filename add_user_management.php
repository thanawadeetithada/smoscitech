        ...
        <form action="" method="POST" autocomplete="off">
            ...
            <select class="form-control" id="userrole" name="userrole" required>
                ...
                <option value="executive"
                    <?= (isset($_POST['userrole']) && $_POST['userrole'] == 'executive') ? 'selected' : ''; ?>>ผู้บริหาร
                </option>
            ...
            <input type="password" id="confirmpassword" name="confirmpassword" placeholder="ยืนยันรหัสผ่าน" required class="form-control" >
